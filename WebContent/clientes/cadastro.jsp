            ...
            <form class="form-horizontal" role="form" id="form" name="form" method="post" action="../Controlador">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <input type= "hidden" name="formulario" value = "addc">
              ...
              <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                  <button type="submit" class="btn btn-danger" onclick="validar(document.form.cpf.value, document.form.email.value, document.form, document.form.valCPF, document.form.valEmail)">Cadastrar</button>
                </div>
              </div>
            </form>
          </div>
